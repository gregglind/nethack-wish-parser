...
export const OBJECTS: ObjectDef[] = [
  ...
  { otyp: 'BEARTRAP', actualName: 'bear trap', class: 'tool', prob: 15, cost: 35, weight: 20, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'iron', rustprone: true },
  { otyp: 'LAND_MINE', actualName: 'land mine', class: 'tool', prob: 15, cost: 25, weight: 20, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'mineral' },
  ...
  { otyp: 'WOODEN_HARP', actualName: 'wooden harp', class: 'tool', prob: 15, cost: 30, weight: 30, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'wood', flammable: true },
  { otyp: 'MAGIC_HARP', actualName: 'magic harp', description: 'wooden harp', class: 'tool', prob: 5, cost: 25, weight: 30, stackable: false, chargeable: true, magic: true, unique: false, noWish: false, big: false, material: 'wood', flammable: true },
  { otyp: 'HELMET', actualName: 'helmet', class: 'armor', prob: 100, cost: 10, weight: 30, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'iron', rustprone: true },
  ...
  // ---- Weapons added as artifact base types ----
  { otyp: 'RUNESWORD', actualName: 'runesword', description: 'broadsword', class: 'weapon', prob: 0, cost: 300, weight: 40, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'iron', rustprone: true },
  { otyp: 'WAR_HAMMER', actualName: 'war hammer', class: 'weapon', prob: 27, cost: 5, weight: 50, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'iron', rustprone: true },
  { otyp: 'BATTLE_AXE', actualName: 'battle-axe', class: 'weapon', prob: 5, cost: 40, weight: 120, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: true, material: 'iron', rustprone: true },
  { otyp: 'ORCISH_DAGGER', actualName: 'orcish dagger', description: 'crude dagger', class: 'weapon', prob: 60, cost: 4, weight: 10, stackable: true, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'iron', rustprone: true, poisonable: true },
  { otyp: 'ELVEN_BROADSWORD', actualName: 'elven broadsword', description: 'runed broadsword', class: 'weapon', prob: 5, cost: 10, weight: 60, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'iron', rustprone: true },
  { otyp: 'ELVEN_DAGGER', actualName: 'elven dagger', description: 'runed dagger', class: 'weapon', prob: 40, cost: 4, weight: 10, stackable: true, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'iron', rustprone: true, poisonable: true },
  { otyp: 'SILVER_MACE', actualName: 'silver mace', class: 'weapon', prob: 8, cost: 40, weight: 30, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'silver' },
  { otyp: 'MORNING_STAR', actualName: 'morning star', class: 'weapon', prob: 20, cost: 10, weight: 120, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: true, material: 'iron', rustprone: true },
  { otyp: 'KATANA', actualName: 'katana', description: 'samurai sword', class: 'weapon', prob: 15, cost: 80, weight: 40, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'iron', rustprone: true },
  { otyp: 'MACE', actualName: 'mace', class: 'weapon', prob: 100, cost: 5, weight: 30, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'iron', rustprone: true },
  { otyp: 'QUARTERSTAFF', actualName: 'quarterstaff', class: 'weapon', prob: 12, cost: 5, weight: 40, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: true, material: 'wood', flammable: true },
  { otyp: 'BOW', actualName: 'bow', class: 'weapon', prob: 10, cost: 60, weight: 30, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: true, material: 'wood', flammable: true },
  { otyp: 'TSURUGI', actualName: 'tsurugi', description: 'long samurai sword', class: 'weapon', prob: 2, cost: 500, weight: 60, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: true, material: 'iron', rustprone: true },
  { otyp: 'MIRROR', actualName: 'mirror', class: 'tool', prob: 15, cost: 15, weight: 13, stackable: false, chargeable: false, magic: false, unique: false, noWish: false, big: false, material: 'glass' },

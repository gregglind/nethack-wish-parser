...
const GROUP_DESCRIPTIONS: Record<string, string> = {
  ...
  'Randomness showcase': 'Wishes that resolve to something random rather than one specific thing, via several different mechanisms (random class, random-within-class, an o_ranges sub-range, glass color, tin/figurine creation-time content).',
